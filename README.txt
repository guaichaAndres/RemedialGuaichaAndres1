...
a persistence unit "RemedialGuaichaAndresPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "RemedialGuaichaAndres\pom.xml":
...
artifact ("RemedialGuaichaAndres.war") is already built. You can build
